...
PhaserMMORPG.Avatar.prototype.runDown = function () {
	if(this.mainSprite.body.onFloor()){
		...
		PhaserMMORPG.Avatar.prototype.checkOnFloor = true;
	}
  this.mainSprite.body.velocity.y += PhaserMMORPG.settings.player.runSpeed;
...
PhaserMMORPG.Avatar.prototype.jumpUp = function () {
  this.mainSprite.body.velocity.y -= 800;
  this.update();
}

PhaserMMORPG.Avatar.prototype.checkOnFloor = function () {
	if(this.mainSprite.body.onFloor()){
		console.log("body on the floor");
...
PhaserMMORPG.Avatar.prototype.updateMovementWhenPositionChanged = function (x,y) {
	  this.mainSprite.x = x;
  this.mainSprite.y = y;
  this.update();
}
